...
.. image:: create_rental_order/rental-order.png
...
Once complete, click :guilabel:`Apply` in the calendar pop-up form. After that, the pop-up form
disappears, and the rental's designated time period is displayed in the :guilabel:`Duration` field.
...
.. note::
   ...
   Rental Prices` in the :guilabel:`Duration` field.
...
.. image:: create_rental_order/schedule-by-resource.png
...
.. image:: create_rental_order/task-related-to-rental-order.png
