...
To link a bank account to a contact, open an Odoo app with access to contacts
(e.g., **Accounting** or **Contacts** app), choose a contact, then go to the :guilabel:`Accounting`
tab. In :guilabel:`Bank Accounts`, click :guilabel:`Add a line` and fill in
:guilabel:`Account Number`, :guilabel:`Bank`, :guilabel:`Account Holder Name`, :guilabel:`Account
Holder`, and, if needed, :guilabel:`Company` and :guilabel:`Currency`. Toggle :guilabel:`Send Money`
to mark the account as 'trusted'.
